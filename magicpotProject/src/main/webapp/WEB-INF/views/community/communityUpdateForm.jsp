...
<body>
    ...
    <div id="outer">
        ...
        <div id="cm_listArea" align="center">
            <form action="update.cm" id="enrollForm" method="post" enctype="multipart/form-data">
                <input type="hidden" name="cmNo" value="${ cm.cmNo }">
                <div id="cm_listArea2" >
                    <table id="cm_enrollTable">
                        <tr>
                            <td colspan="2">
                                <select name="cmCategory" id="cm_category" required>
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="text" name="cmTitle" id="cm_title" placeholder="제목을 입력해주세요" required value="${ cm.cmTitle }">
                            </td> 
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                <c:choose>
	                                <c:when test="${ !empty cm.cmImage }">
	                                	<input type="text" id="cmImageTitle" value="${ cm.cmImage }" readonly>
                        ...
                        <tr>
                            <td colspan="2" >
                                <textarea id="summernote" name="cmContent">${ cm.cmContent }</textarea>
                            </td>
                        </tr>
                    </table>
                </div>
		    	...
		    	<script>
			    	$(function(){
			    		$("#cm_listArea2 option[value=${cm.cmCategory}]").attr("selected", true);
			    	})
		    	</script>

                <!-- 버튼 영역 -->
                <div id="cm_enrollBtn" align="right">
                    <a href="" id="cmEnrollBtn1" class="btn btn-success" data-toggle="modal" onclick="return checkValidation();" data-target="#cmUpdateBtn">수정</a>
	    ...
	    <script>
	   	 	function checkValidation(){
		   	 	if($('#cmCategory option:selected').val() == '' 
		   	 		...
		   	 		$("#cmEnrollBtn1").attr("data-target", "#cmUpdateBtn");
		   	 	}
	   	 	}
	    </script>
